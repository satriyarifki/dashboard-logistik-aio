...
@Component({
  selector: 'app-input-skb-edit',
  templateUrl: './input-skb-edit.component.html',
  styleUrls: ['./input-skb-edit.component.css'],
})
export class InputSkbEditComponent {
  ...
  onSubmitTrucking() {
    ...
    this.apiService.updateSukabumiTrucking(this.dataApi.id, body).subscribe(
      (data) => {
  ...
  onSubmitDelivery() {
    ...
    this.apiService.updateSukabumiDelivery(this.dataApi.id, body).subscribe(
      (data) => {
  ...
  onSubmitOnTime() {
    ...
    this.apiService.updateSukabumiOnTime(this.dataApi.id, body).subscribe(
      (data) => {
  ...
  onSubmitDamage() {
    ...
    this.apiService.updateSukabumiDamage(this.dataApi.id, body).subscribe(
      (data) => {
  ...
  onSubmitPerfect() {
    ...
    this.apiService.updateSukabumiPerfect(this.dataApi.id, body).subscribe(
      (data) => {
  ...
  onSubmitHandling() {
    ...
    this.apiService.updateSukabumiHandling(this.dataApi.id, body).subscribe(
      (data) => {
